				...
				<div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
					...
					<div class="card shadow-lg">
						<div class="card-body p-5">
							...
							<form action="cek-login.php" method="POST" class="needs-validation" autocomplete="off">
								<div class="mb-3">
                        ...
                        <div class="text-center">
								Belum punya akun? <a href="../registrasi/registrasi.php" class="text-dark">Registrasi</a>
							</div>
              <div class="text-center">
              <a href="../registrasi/registrasi.php" class="text-dark">Petugas</a>
							</div>
